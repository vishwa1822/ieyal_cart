                      ...
                      {days.map((d, i) => {
                        ...
                        return (
                          <motion.button
                            ...
                            className={`relative shrink-0 w-14 sm:w-15 py-2 rounded-xl border text-center overflow-hidden ${
                              active
                                ? "text-white border-[var(--iy-accent)] shadow-[var(--iy-shadow-xs)]"
                                : "border-[var(--iy-border)] bg-[var(--iy-bg)] text-[var(--iy-ink-soft)] hover:border-[var(--iy-accent)]/50 hover:text-[var(--iy-ink)]"
                            }`}
                          >
                            {active && (
                              <motion.span
                                layoutId="dateActivePill"
                                transition={{ type: "spring", stiffness: 450, damping: 32 }}
                                className="absolute inset-0 bg-[var(--iy-accent)]"
                              />
                            )}
                    ...
                    {slots.map((s) => {
                      ...
                      return (
                        <motion.button
                          ...
                          whileTap={{ scale: 0.95 }}
                          transition={{ type: "spring", stiffness: 500, damping: 30 }}
                          className={`relative py-2 rounded-xl border text-xs sm:text-sm font-medium overflow-hidden ${
                            active
                              ? "text-white border-[var(--iy-accent)] shadow-[var(--iy-shadow-xs)]"
                              : "border-[var(--iy-border)] bg-[var(--iy-bg)] text-[var(--iy-ink-soft)] hover:border-[var(--iy-accent)]/50 hover:text-[var(--iy-ink)]"
                          }`}
                    ...
                    {[1, 2, 3, 4, 5, 6, 8, 10].map((n) => {
                      ...
                      return (
                        <motion.button
                          ...
                          whileTap={{ scale: 0.95 }}
                          transition={{ type: "spring", stiffness: 500, damping: 30 }}
                          className={`relative h-9 sm:h-10 min-w-9 px-3 rounded-full border text-xs sm:text-sm font-semibold overflow-hidden ${
                            active
                              ? "text-white border-[var(--iy-accent)] shadow-[var(--iy-shadow-xs)]"
                              : "border-[var(--iy-border)] bg-[var(--iy-bg)] text-[var(--iy-ink-soft)] hover:border-[var(--iy-accent)]/50 hover:text-[var(--iy-ink)]"
                          }`}
